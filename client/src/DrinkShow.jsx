  ...
  return (
    <>
      ...
      <div className='drink-show'>
        <img src={props.drink.picture} alt="drink" className="singledrinkpic"/>
        <div className="descriptionbox">
          <img src="https://images.unsplash.com/photo-1530034424313-9be028eeae5a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1600&q=80" alt="drink" id="drunkperson"/>
